---
title: 6.【分布式系统架构】Kubernetes装备数据卷
date: 2019-11-22 14:32:43
categories: 
- 分布式系统架构
- Kubernetes
---
...
```bash
mount 192.168.220.130:/usr/local/kubernetes/volumes /usr/local/kubernetes/volumes-mount
```
...
# 有此输出表示挂载成功
192.168.220.130:/usr/local/kubernetes/volumes  19475200 4780800  13681920  26% /usr/local/kubernetes/volumes-mount
```
